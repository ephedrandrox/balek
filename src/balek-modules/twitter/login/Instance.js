...
define(['dojo/_base/declare',
        'balek-modules/Instance',],                                     //Array of files to include
    function (declare, baseInstance) {                                  //variables from array of included files
        return declare("moduleTwitterLoginInstance", baseInstance, {    //Declares instance extending base instance
