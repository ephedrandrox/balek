...
define([
  ...
  return declare(
    "moduleDigivigilDigiscanInterface",
    _SyncedCommanderInterface,
    {
      _instanceKey: null,
      //Interface Widgets
        ...
        if (name === "availableCapturesComponentKey") {
          ...
          if (
            ...
            for (const ResolveKey in this.interestedCapturesResolveRequests) {
              this.interestedCapturesResolveRequests[ResolveKey](
                this.interestedCaptures
              );
            }
          }
          ...
          if (
            ...
            this.captureSetsWatchHandle =
              this.captureSetsSyncedMap.setStateWatcher(
                lang.hitch(this, this.onCaptureSetStateChange)
              );
          ...
          if (
            ...
            this.uiStateWatchHandle = this.uiStateSyncedMap.setStateWatcher(
                          ...
                          this.workspaceManagerCommands
                            ...
                            .catch(
                              lang.hitch(this, function (error) {
                                console.log(
                                  "Error adding container to workspace",
                                  error
                                );
                              })
                            );
          ...
          if (this._settingsInterface === null) {
            this._settingsInterface = new SettingsInterface({
              _instanceKey: newState.instanceKey,
              _sessionKey: newState.sessionKey,
              _componentKey: newState.componentKey,
              _interface: this,
      ...
      getCaptureSetSyncedMap: function (captureSetID, resultCallback) {
        ...
        this._instanceCommands
          .getCaptureSetSyncedMap(captureSetID)
          .then(
            lang.hitch(this, function (commandReturnResults) {
              //  console.log("#getCaptureSetSyncedMap", commandReturnResults)
              resultCallback(commandReturnResults);
      ...
      newAllSet: function (setName, resultCallback) {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#newAllSet",
              "newAllSet Received Error Response" + commandErrorResults
            );
          });
      },
      newClearSet: function (setName, resultCallback) {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#newClearSet",
              "newClearSet Received Error Response" + commandErrorResults
            );
          });
      },
      deleteCaptureSet: function (id) {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#deleteCaptureSet",
              "deleteCaptureSet Received Error Response" + commandErrorResults
            );
          });
      },
      renameCaptureSet: function (id, name) {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#renameCaptureSet",
              "renameCaptureSet Received Error Response" + commandErrorResults
            );
          });
      },
      clearCaptureSet: function (id, name) {
        this._instanceCommands
          .clearCaptureSet(id, name)
          .then(
            lang.hitch(this, function (commandReturnResults) {
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#clearCaptureSet",
              "clearCaptureSet Received Error Response" + commandErrorResults
            );
          });
      },
      selectCaptureSet: function (id) {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#selectCaptureSet",
              "selectCaptureSet Received Error Response" + commandErrorResults
            );
          });
      },
      ...
      sendEntry: function (digiscanEntry) {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#ADDENTRY",
              "ADDENTRY Received Error Response" + commandErrorResults
            );
          });
      },
      removeCaptureFromSet: function (captureSetID, captureID, resultCallback) {
        console.log(
          "#removeCaptureFromSet",
          captureSetID,
          captureID,
          resultCallback
        );
      ...
      removeAllCaptures: function () {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#Removed ALl Captures",
              "Removed ALl Captures Received Error Response" +
                commandErrorResults
            );
          });
      },
      showHiddenCaptures: function (showHidden) {
        this._instanceCommands
          ...
          .catch(function (commandErrorResults) {
            console.log(
              "#showHiddenCaptures",
              "Received Error Response" + commandErrorResults
            );
          });
      },
