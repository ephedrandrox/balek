define(['dojo/_base/declare',
    ...
    function (declare, lang, topic, domClass, domConstruct, win, on, domAttr, domStyle, dojoKeys,
        ...
        return declare("digivigilDigiscanCaptureRowViewInterface", [_WidgetBase, _TemplatedMixin], {
            ...
            mainInterface: null,            //passed argument
            ...
            onCopyCodeClick: function (clickEvent){
                if(this.captureState !== null)
                {
                    this.mainInterface.copyTextToClipboard(this.captureState.get("barcode"))
                }else{
                    alert("Try again.")
                }
