  ...
  return declare("digivigilDigiscanCaptureSetssInterfaceController", null, {
    ...
    constructor: function (args) {
      ...
      if (this._interface === null) {
        console.log(
          "Scaptura Captures Sets Interface Controller Cannot Start!..."
        );
      } else {
    ...
    getCaptureSetByID: function (captureSetID) {
      if (
        ...
        this._interface.getCaptureSetSyncedMap(
          captureSetID,
          lang.hitch(this, function (syncedMapKeys) {
            //create a syncedMap Interface and store it by CaptureID
            this.captureSetSyncedMaps[captureSetID] = new SyncedMapInterface({
            ...
            this.captureSetSyncedMapWatchHandles[captureSetID] =
