/*
   Scaptura Interface: List Control Widget
    ...
    Menubar like control across top of display
...
define([
  ...
  return declare(
    "digivigilDigiscanCaptureViewInterface",
    [_WidgetBase, _TemplatedMixin],
    {
      ...
      onClickNewSet: function (clickEvent) {
        let getNameForList = new getUserInput({
          question: "Choose Set Name",
      ...
      _onNewOver: function (overEvent) {
        this.updateStatusText(
          "🔆 Click To Create New Set <br/>" + "💬 After Input Dialog"
        );
      },
      ...
      refreshViews: function () {
        ...
        if (this.uiState != null) {
          ...
          if (selectedCaptureSet && this.captureSets[selectedCaptureSet]) {
          ...
          if (this.captureSets !== null) {
            for (captureSetID in this.captureSets) {
              if (
                ...
                const captureSetSelectDiv = this.captureSetSelectButton(
                  captureSetID,
                  captureSetName
                );
      ...
      captureSetSelectButton: function (id, name) {
        ...
        on(
          selectButton,
          ["mouseover"],
          lang.hitch(this, function (clickEvent) {
            this.updateStatusText(
              "🔆 Click and switch to <b>" +
                name +
                "</b> Set" +
