define([
  ...
  return declare(
    "moduleDigivigilWWWSaleTagScanInstance",
    _SyncedCommanderInstance,
    {
      _instanceKey: null,
      ...
      constructor: function (args) {
        ...
        this.importerInstancesSyncedMap = new SyncedMapInstance({
          _instanceKey: this._instanceKey,
          _commonName: "ImporterInstances",
        });
        //todo remove synced map from tab importer but add to dataTables
        this._interfaceState.set(
          "importerInstancesSyncedMapComponentKey",
          this.importerInstancesSyncedMap._componentKey
        );
...
*/
      ...
      newImporter: function (returnCallback) {
        ...
        let newImporter = new ImporterInstance({
          _instanceKey: this._instanceKey,
          _sessionKey: this._sessionKey,
          _userKey: this._userKey,
        });
        this.importerInstancesSyncedMap.add(newImporter._componentKey, {
          instanceKey: newImporter._instanceKey,
