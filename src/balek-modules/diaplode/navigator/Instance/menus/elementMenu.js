define(['dojo/_base/declare',
    ...
    'balek-modules/diaplode/navigator/Instance/menus/elementsMenu/elementMenu'
    ...
    function (declare,
              ...
              syncedMapInstance,
              elementMenu) {
        return declare("moduleDiaplodeNavigatorElementMenuInstance", [_syncedCommanderInstance], {
            _instanceKey: null,
            _sessionKey: null,
            _userKey: null,
            _componentKey: null,
            ...
            constructor: function (args) {
                ...
                this._menuNames = {};
                //todo remove after adding element type id
                ...
                if(this._instanceKey !== null && this._sessionKey !== null && this._userKey !== null && this._componentKey !== null )
                {
                    ...
                    this._interfaceState.set("componentModule", "Navigator Element Menu");
                ...
                console.log("moduleDiaplodeElementMenuInstance starting...");
            },
            ...
            newMenu:function(status, remoteCommandCallback){
                ...
                if(status._syncedMapComponentKey &&  status._syncedMapInstanceKey &&status._menuName){
                    ...
                    if(!this._menuNames[status._menuName]){
                        let newMenu = elementMenu({ _syncedMapComponentKey: status._syncedMapComponentKey,
